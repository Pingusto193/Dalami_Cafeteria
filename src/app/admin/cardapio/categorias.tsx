...
import { Aviso, Campo, Cartao, Excluir, Interruptor, Ordem, Salvar } from "../componentes";
import { apagarCategoria, moverCategoria, salvarCategoria } from "./acoes";
...
export function Categorias({ categorias }: { categorias: Cat[] }) {
  ...
  const [, acaoMover] = useActionState(moverCategoria, null);
            ...
            {editando === c.id ? (
              ...
              <div className="flex items-center gap-3">
                <form action={acaoMover}>
                  ...
                  <Ordem primeiro={i === 0} ultimo={i === categorias.length - 1} />
                </form>
